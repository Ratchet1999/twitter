...
ActiveRecord::Schema[7.0].define(version: 2023_07_03_132747) do
  ...
  create_table "followers_followings", id: false, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["followee_id"], name: "index_followers_followings_on_followee_id"
  ...
  add_foreign_key "followers_followings", "users", column: "followee_id"
